...
details:
- title: Brief
  text: Saari were employed to define Supercan B2B and B2C customer acquisition strategies
    alongside wider business development and strategic work.
- title: Approach
  text: Plugging into the internal team of Supercan we upskilled and helped define
    the best most cost efficient approach to the delivery of a new Nordic startup
